...
<div class="section">
  ...
  <div class="info-grid">
    ...
    <div class="info-item"><div class="info-label">BHW on Duty</div>{bhw_name}</div>
...
<div class="disclaimer">
  ⚠️ <strong>Para sa kaalaman ng BHW at doktor lamang.</strong> Hindi ito opisyal na medikal na rekord.
